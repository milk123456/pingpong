...
for data in data_set:
    ...
    for i, sceneInfo in enumerate(data["scene_info"][3:-1]):
        # Frames.append(sceneInfo["frame"])
        Ball_x.append(sceneInfo["ball"][26])
        Ball_y.append(sceneInfo["ball"][51])
        Ball_speed_x.append(sceneInfo["ball_speed"][13])
        Ball_speed_y.append(sceneInfo["ball_speed"][-13])
...
with open(os.path.join(path, "model2.pickle"), 'wb') as f:
    pickle.dump(model, f)
